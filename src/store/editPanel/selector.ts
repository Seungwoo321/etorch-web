...
export const selectXAxisType = (state: XAxisOptionStore): 'number' | 'category' | undefined => state.xAxisType
export const selectXAxisTickAngle = (state: XAxisOptionStore): number => state.xAxisTickAngle
export const selectXAxisDomainMin = (state: XAxisOptionStore): number | 'auto' => state.xAxisDomainMin
export const selectXAxisDomainMax = (state: XAxisOptionStore): number | 'auto' => state.xAxisDomainMax
export const selectXAxisAxisLine = (state: XAxisOptionStore): boolean => state.xAxisAxisLine
export const selectXAxisTickSize = (state: XAxisOptionStore): number => state.xAxisTickSize
export const selectXAxisTickLine = (state: XAxisOptionStore): boolean => state.xAxisTickLine
export const selectXAxisColor = (state: XAxisOptionStore): string => state.xAxisColor
...
export const selectPanelsData = (state: DataOptionStore) => state.panels.filter(panel => (panel.data.length > 0) && panel.frequency === state.frequency)
